...
var serialize = require('./serialize'); // This is a special fetch which does OIDC auth, catching 401 errors


var _ref = typeof window === "undefined" ? require('solid-auth-cli') : require('solid-auth-client'),
    fetch = _ref.fetch;
