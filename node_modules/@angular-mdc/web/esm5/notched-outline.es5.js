 ...
 */
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, Directive, ElementRef, HostBinding, Renderer2, ViewChild, ViewEncapsulation, NgModule } from '@angular/core';
...
var MdcNotchedOutlineIdle = /** @class */ (function () {
    ...
    MdcNotchedOutlineIdle.propDecorators = {
        isHostClass: [{ type: HostBinding, args: ['class.mdc-notched-outline__idle',] }]
    };
...
var MdcNotchedOutline = /** @class */ (function () {
    ...
    MdcNotchedOutline.decorators = [
        { type: Component, args: [{selector: '[mdc-notched-outline], mdc-notched-outline',
    ...
    MdcNotchedOutline.propDecorators = {
        isHostClass: [{ type: HostBinding, args: ['class.mdc-notched-outline',] }],
        svgpath: [{ type: ViewChild, args: ['svgpath',] }]
    };
    return MdcNotchedOutline;
}());
...
export { MdcNotchedOutlineModule, MdcNotchedOutlineIdle, MdcNotchedOutline };
