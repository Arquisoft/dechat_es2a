 ...
 */
import { ElementRef, Renderer2, Injectable, ChangeDetectionStrategy, ChangeDetectorRef, Component, Directive, Input, NgZone, NgModule } from '@angular/core';
...
var MdcRipple = /** @class */ (function () {
    function MdcRipple(_renderer, _registry, elementRef) {
        var _this = this;
        ...
        this._mdcAdapter = {
            ...
            isSurfaceDisabled: function () { return _this._disabled || _this.isSurfaceDisabled(); },
            ...
            containsEventTarget: function (target) { return _this._getHostElement().contains(target); },
            registerInteractionHandler: function (evtType, handler) {
                return _this._registry.listen(evtType, handler, _this._interactionElement ? _this._interactionElement : _this._getHostElement(), applyPassive());
            },
            ...
            updateCssVariable: function (varName, value) {
                return _this._renderer.setStyle(_this._getHostElement(), varName, value, 2);
            },
     ...
     * @return {?}
     */
    MdcRipple.prototype.setDisabled = /**
     * @param {?} value
     * @return {?}
     */
    function (value) {
     ...
     */
    function () {
        return this._surfaceActive || this._getHostElement()[getMatchesProperty(HTMLElement.prototype)](':active');
    };
    /**
     * @return {?}
     */
     ...
     * @return {?}
     */
    MdcRipple.prototype._getHostElement = /**
     * Retrieves the DOM element of the component host.
     * @return {?}
     */
    function () {
