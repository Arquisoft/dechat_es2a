...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/core'), require('@angular-mdc/web/common'), require('rxjs/operators')) :
  typeof define === 'function' && define.amd ? define('@angular-mdc/web/snackbar', ['exports', 'rxjs', '@angular/core', '@angular-mdc/web/common', 'rxjs/operators'], factory) :
  (factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.snackbar = {}),global.Rx,global.ng.core,global.ng.web.common,global.Rx.operators));
}(this, (function (exports,rxjs,core,common,operators) { 'use strict';
  ...
  function (_MDCFoundation) {
    ...
    function MDCSnackbarFoundation(adapter) {
      ...
      _this = _possibleConstructorReturn$1(this, (MDCSnackbarFoundation.__proto__ || Object.getPrototypeOf(MDCSnackbarFoundation)).call(this, Object.assign(MDCSnackbarFoundation.defaultAdapter, adapter)));
      _this.active_ = false;
      ...
      _this.visibilitychangeHandler_ = function () {
        ...
        if (!_this.adapter_.visibilityIsHidden()) {
          setTimeout(_this.cleanup_.bind(_assertThisInitialized$1(_this)), _this.snackbarData_.timeout || numbers.MESSAGE_TIMEOUT);
        }
      };
      ...
      _this.blurHandler_ = function () {
        clearTimeout(_this.timeoutId_);
        _this.snackbarHasFocus_ = false;
        _this.timeoutId_ = setTimeout(_this.cleanup_.bind(_assertThisInitialized$1(_this)), _this.snackbarData_.timeout || numbers.MESSAGE_TIMEOUT);
      };
  ...
  function (_MDCComponent) {
    ...
    function MDCSnackbar() {
      ...
      return _possibleConstructorReturn$1(this, (MDCSnackbar.__proto__ || Object.getPrototypeOf(MDCSnackbar)).apply(this, arguments));
    }
  ...
  var MdcSnackbarModule = /** @class */ (function () {
      ...
      MdcSnackbarModule.decorators = [
          { type: core.NgModule, args: [{
                      ...
                      providers: [MdcSnackbar, common.MdcPortalService],
