...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular-mdc/web/ripple'), require('@angular-mdc/web/button'), require('rxjs'), require('@angular-mdc/web/common'), require('@angular/common'), require('@angular-mdc/web/portal'), require('@angular-mdc/web/overlay')) :
  typeof define === 'function' && define.amd ? define('@angular-mdc/web/dialog', ['exports', '@angular/core', '@angular-mdc/web/ripple', '@angular-mdc/web/button', 'rxjs', '@angular-mdc/web/common', '@angular/common', '@angular-mdc/web/portal', '@angular-mdc/web/overlay'], factory) :
  (factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.dialog = {}),global.ng.core,global.ng.web.ripple,global.ng.web.button,global.Rx,global.ng.web.common,global.ng.common,global.ng.web.portal,global.ng.web.overlay));
}(this, (function (exports,core,ripple,button,rxjs,common,common$1,portal,overlay) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  var MdcDialogBackdrop = /** @class */ (function () {
      ...
      MdcDialogBackdrop.propDecorators = {
          isHostClass: [{ type: core.HostBinding, args: ['class.mdc-dialog__backdrop',] }]
      };
  ...
  function (_MDCFoundation) {
    ...
    function MDCDialogFoundation(adapter) {
      ...
      _this = _possibleConstructorReturn$1(this, (MDCDialogFoundation.__proto__ || Object.getPrototypeOf(MDCDialogFoundation)).call(this, Object.assign(MDCDialogFoundation.defaultAdapter, adapter)));
      _this.isOpen_ = false;
  ...
  function (_MDCComponent) {
    ...
    function MDCDialog() {
      ...
      return _possibleConstructorReturn$1(this, (MDCDialog.__proto__ || Object.getPrototypeOf(MDCDialog)).apply(this, arguments));
    }
  ...
  var MdcDialogComponent = /** @class */ (function () {
       ...
       */
      function (event) {
          if (common.ESCAPE === event.keyCode) {
      ...
      MdcDialogComponent.propDecorators = {
          ...
          dialogSurface: [{ type: core.ViewChild, args: [MdcDialogSurface,] }],
          dialogBody: [{ type: core.ContentChild, args: [MdcDialogBody,] }],
          dialogButtons: [{ type: core.ContentChildren, args: [MdcDialogButton, { descendants: true },] }]
      };
   ...
   * @suppress {checkTypes} checked by tsc
   */
  var /** @type {?} */ MDC_DIALOG_DATA = new core.InjectionToken('MdcDialogData');
  ...
  var MdcDialog = /** @class */ (function () {
      ...
      function (overlay$$1, config) {
          var /** @type {?} */ containerPortal = new portal.ComponentPortal(MdcDialogContainer, config.viewContainerRef);
  ...
  exports.MdcDialogBackdrop = MdcDialogBackdrop;
