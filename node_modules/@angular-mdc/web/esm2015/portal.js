 ...
 */
import { ComponentFactoryResolver, Directive, NgModule, TemplateRef, ViewContainerRef } from '@angular/core';
...
class DomPortalOutlet extends BasePortalOutlet {
    ...
    attachTemplatePortal(portal) {
        const /** @type {?} */ viewContainer = portal.viewContainerRef;
        const /** @type {?} */ viewRef = viewContainer.createEmbeddedView(portal.templateRef, portal.context);
        ...
        this.setDisposeFn((() => {
            const /** @type {?} */ index = viewContainer.indexOf(viewRef);
            if (index !== -1) {
...
export { Portal, ComponentPortal, TemplatePortal, BasePortalOutlet, DomPortalOutlet, CdkPortal, CdkPortalOutlet, PortalModule, PortalInjector };
